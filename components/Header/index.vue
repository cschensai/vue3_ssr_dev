        ...
        <div class="content-box">
          ...
          <div class="sub-menu-box">
            <div class="sub-menu-box-item" v-for="item in SUB_MENU_LIST" :key="item.key" @click="handleNavAction(item.key)">
              <nuxt-img lazy="loading" class="icon-img-logo" :src="`https://static.desty.app/desty-homepage/v2/${item.icon}.svg`" alt="Desty App, Desty Omni, Desty Page, Desty Store, Desty Menu" />
              {{ item.text }}
            </div>
          </div>
        </div>
